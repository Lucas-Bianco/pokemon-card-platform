...
type Tab = "home" | "scan" | "vault" | "binder" | "wants" | "alerts" | "deals" | "prices" | "ledger" | "sealed" | "catalog" | "browse" | "sets" | "shop" | "more";
...
const TAB_COMMANDS: { tab: Tab; label: string; hint: string }[] = [
  ...
  { tab: "wants", label: "Go to Wants", hint: "Want list / hunt list" },
