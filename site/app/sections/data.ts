...
export const ROADMAP: Phase[] = [
  ...
  { n: "32", title: "Phase B — key-feature polish", subtitle: "Take each of the six Key-mode surfaces to its best form, one feature per shipped change. Vault first: the eight stacked panels (insurance, diversification, value-over-time, freshness, acquisition timeline, export, import, sold-ledger) buried the holdings table at the bottom — reordered so the table is primary content under the KPIs, action tools (export / import / sold-ledger) grouped in an open Tools section, and the five read-only analytics panels grouped in a collapsible Analytics section (default open); every panel still mounts, the Log-sale prefill/scroll flow preserved · shipped (commit d639cb0); Scan, Binder, Sets, Sealed, Deals next", status: "progress" },
];
